...
//Touches entrées, initialise la direction et le booléen 
//  _lose si Q est touché
void game::inputKey() {
...
bool game::canMove(const point& p) const {
    ...
    if (_ekans.ifCollision(p)) {
        ...
        // si la tête du serpent frappe un mur;
...
// affiche le jeu graphique a l'écran
