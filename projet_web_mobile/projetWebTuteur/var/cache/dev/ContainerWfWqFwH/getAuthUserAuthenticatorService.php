 ...
 */
class getAuthUserAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\AuthUserAuthenticator' shared autowired service.
     *
     * @return \App\Security\AuthUserAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'AuthUserAuthenticator.php';

        return $container->privates['App\\Security\\AuthUserAuthenticator'] = new \App\Security\AuthUserAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
