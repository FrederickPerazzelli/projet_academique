 ...
 */
class getDemandRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandRepository' shared autowired service.
     *
     * @return \App\Repository\DemandRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandRepository.php';

        return $container->privates['App\\Repository\\DemandRepository'] = new \App\Repository\DemandRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
