 ...
 */
class getStatusTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StatusTypeRepository' shared autowired service.
     *
     * @return \App\Repository\StatusTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StatusTypeRepository.php';

        return $container->privates['App\\Repository\\StatusTypeRepository'] = new \App\Repository\StatusTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
