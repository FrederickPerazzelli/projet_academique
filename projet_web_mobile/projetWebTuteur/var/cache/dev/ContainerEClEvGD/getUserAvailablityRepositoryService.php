 ...
 */
class getUserAvailablityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserAvailablityRepository' shared autowired service.
     *
     * @return \App\Repository\UserAvailablityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserAvailablityRepository.php';

        return $container->privates['App\\Repository\\UserAvailablityRepository'] = new \App\Repository\UserAvailablityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
