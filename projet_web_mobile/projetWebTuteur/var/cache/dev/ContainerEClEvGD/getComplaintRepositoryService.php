 ...
 */
class getComplaintRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComplaintRepository' shared autowired service.
     *
     * @return \App\Repository\ComplaintRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComplaintRepository.php';

        return $container->privates['App\\Repository\\ComplaintRepository'] = new \App\Repository\ComplaintRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
